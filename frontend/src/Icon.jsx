...
export function CloseEye({ size = 24, className, ...props }) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
      ...
      className={className}
    >
      <path d="M5.112 18.784l-2.153 2.156c-.585.586-.585 1.536.001 2.121.586.585 1.536.585 2.121-.001l2.666-2.668c1.898.983 4.19 1.806 6.773 2.041l0 3.567c0 .828.672 1.5 1.5 1.5.828 0 1.5-.672 1.5-1.5l0-3.571c2.147-.201 4.091-.806 5.774-1.571l3.199 3.202c.585.586 1.535.586 2.121.001.586-.585.586-1.535.001-2.121l-2.579-2.581c2.59-1.665 4.091-3.369 4.091-3.369.546-.622.485-1.57-.137-2.117-.622-.546-1.57-.485-2.117.137 0 0-4.814 5.49-11.873 5.49-7.059 0-11.873-5.49-11.873-5.49-.547-.622-1.495-.683-2.117-.137-.622.547-.683 1.495-.137 2.117 0 0 1.175 1.334 3.239 2.794Z" />
    </svg>
  );
}

export function OpenEye({ size = 24, className, ...props }) {
  return (
    <svg
      {...props}
      xmlns="http://www.w3.org/2000/svg"
      ...
      className={className}
    >
      <path d="M97.204 45.788c-.865-1.02-21.537-24.945-47.963-24.945-26.427 0-47.098 23.925-47.965 24.946-1.701 2-1.701 4.902.001 6.904.866 1.02 21.537 24.944 47.964 24.944 26.426 0 47.098-23.926 47.964-24.946 1.702-2 1.702-4.902 0-6.903zM57.313 35.215c1.777-.97 4.255.143 5.534 2.485 1.279 2.343.875 5.029-.902 5.999-1.776.971-4.255-.143-5.535-2.485-1.278-2.343-.875-5.029.903-5.999zM49.241 68.969c-18.46 0-33.995-14.177-39.372-19.729 3.631-3.75 11.898-11.429 22.567-16.021-2.081 3.166-3.301 6.949-3.301 11.021 0 11.104 9.001 20.105 20.105 20.105s20.106-9.001 20.106-20.105c0-4.072-1.219-7.855-3.3-11.021 10.669 4.592 18.935 12.27 22.566 16.02-5.377 5.555-20.912 19.729-39.371 19.729z" />
    </svg>
  );
}
