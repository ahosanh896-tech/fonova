        ...
        <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 mb-10 mt-10 px-6 text-sm">
          ...
          <div>
            ...
            <p className="w-full md:w-2/3 text-gray-600 leading-relaxed">
              Transform your living space with stylish and comfortable
              furniture. We bring modern designs, durable materials, and
              affordable prices to make your home truly yours.
            </p>
          </div>
